...
ptero_images = [
  "Python/Программы/Игры/Dino/game_files/ptero.png",
  "Python/Программы/Игры/Dino/game_files/ptero2.png"
]

SOUND_JUMP = "Python/Программы/Игры/Dino/game_files/jump.mp3"
SOUND_GAME_OVER = "Python/Программы/Игры/Dino/game_files/game_over.mp3"
SOUND_POINT = "Python/Программы/Игры/Dino/game_files/point.mp3"
...
class DinoGame:
  ...
  def load_images(self):
    ...
    self.dino_game_over_img = PhotoImage(file="Python/Программы/Игры/Dino/game_files/dino4.png")
  ...
  def load_sounds(self):
    try:
      ...
      class DummySound:
        def play(self): pass
      self.sound_jump = DummySound()
      self.sound_game_over = DummySound()
      self.sound_point = DummySound()
  ...
  def start_game(self):
    ...
    if self.first_game:
      ...
      self.master.after(17, self.update_jump_before_game)
    else:
